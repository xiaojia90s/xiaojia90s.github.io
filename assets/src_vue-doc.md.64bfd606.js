import{_ as s,o as e,c as n,Q as a}from"./chunks/framework.11973aea.js";const l="/assets/404-image.1ec1f764.png",v=JSON.parse('{"title":"Vue","description":"","frontmatter":{},"headers":[],"relativePath":"src/vue-doc.md","filePath":"src/vue-doc.md"}'),o={name:"src/vue-doc.md"},p=a(`<h1 id="vue" tabindex="-1">Vue <a class="header-anchor" href="#vue" aria-label="Permalink to &quot;Vue&quot;">​</a></h1><h2 id="表单问题" tabindex="-1">表单问题 <a class="header-anchor" href="#表单问题" aria-label="Permalink to &quot;表单问题&quot;">​</a></h2><p>ElementUI 表单校验 number 类型的浮点数，因为 v-model 返回的是字符串，加修饰符 .number 后无法输入小数点，故需要手写自定义校验规则。</p><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">const fn = (rule, value, callback) { </span></span>
